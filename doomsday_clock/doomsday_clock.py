...
class DoomsdayClock:
    ...
    def sentence_to_countdown(cls, sentence: str) -> float:
        """
        Convert Doomsday Clock sentence to a number of minutes to midnight.
        ...
        pattern = (
            ...
            r"|(?P<half>half))"
            r"(?P<and> and a half)? (?:minutes|minute|a minute) to midnight"
        )
    ...
    def countdown_to_time(
        ...
        """
        Convert a number of minutes to midnight into a time format.
